...
var campaignID = "68faf5b68ec43b95e0bad6d3";
...
var initialSrc = "https://thn6m.ttrk.io/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("thn6m.ttrk.io/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://thn6m.ttrk.io/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://thn6m.ttrk.io/view?clickid=" + rtkClickID)
        xhrTrack.send();
